...
VALUES ('AB12345', 'VIN00000000000001', 'Toyota', 'Yaris', 'København', 45000, 'Compact city car', 'AVAILABLE', 1),
       ('CD67890', 'VIN00000000000002', 'Volkswagen', 'Golf', 'Aarhus', 72000, 'Popular family hatchback', 'AVAILABLE',
        1),
       ('EF11223', 'VIN00000000000003', 'Tesla', 'Model 3', 'København', 28000, 'Electric sedan', 'RENTED', 1);

INSERT INTO rental_agreements
(start_date, end_date, downpayment, monthly_payment, max_km, created_by, car_id, customer_id, active)
VALUES ('2026-05-01', '2026-06-01', 5000.00, 3200.00, 15000, 2, 3, 1, 1);
