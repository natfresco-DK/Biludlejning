...
VALUES ('2026-01-01', '2026-06-30', 5000.00, 3200.00, 15000, 1, 2, 1),
       ...
       ('2026-04-01', '2026-04-29', 5000.00, 3200.00, 15000, 1, 6, 1),
       ('2026-01-01', '2026-04-29', 5000.00, 3200.00, 15000, 1, 7, 1);

INSERT INTO damage_reports
    (return_date, report_date, cost, odometer, agreement_id, registered_by)
VALUES ('2026-04-29', '2026-04-29', 0.00, 86500, 4, 2),
       ('2026-04-29', '2026-04-29', 0.00, 39000, 5, 3);
